export const metadata = {
  title: 'Quickstart',
  description:
    'This guide will get you all set up and ready to use Gabriel Zouads API. here you can find all the information about me and my projects through REST API!',
}
...
```bash {{ language: 'js' }}
# Try fetching with a simple fetch request
